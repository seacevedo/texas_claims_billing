-- Derived from int_header_union, int_detail_union, and int_provider_consolidate. The model is built by creating CTEs of all three models and performing left joins on them. Foreign keys are generated by hashing all columns relating to each dimension table.
